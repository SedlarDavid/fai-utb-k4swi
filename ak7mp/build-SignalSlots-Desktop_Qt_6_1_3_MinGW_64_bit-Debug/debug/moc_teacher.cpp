...
QT_MOC_LITERAL(8, 13), // "teacherIncome"
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 13), // "noticeStudent"
QT_MOC_LITERAL(37, 11) // "studentName"

    },
    "Teacher\0teacherIncome\0\0noticeStudent\0"
    "studentName"
};
...
void Teacher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->teacherIncome(); break;
        case 1: _t->noticeStudent((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Teacher::teacherIncome)) {
                *result = 0;
                return;
            }
        }
